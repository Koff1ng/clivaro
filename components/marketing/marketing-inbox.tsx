...
import {
  Search, Send, Inbox, Star, Archive, Sparkles, UserPlus, Plus,
  MailOpen, Clock, User, ChevronRight, Loader2, ArrowLeft,
  MessageCircle, RefreshCw, Filter, Tag,
} from 'lucide-react'
...
export default function MarketingInbox() {
  ...
  const handleAiSuggest = async () => {
    ...
    try {
      ...
      toast('Error al generar sugerencias', 'error')
    } finally {
      setIsAiLoading(false)
    }
  }

  // AI: extract leads from text
  const handleExtractLeads = async () => {
    ...
    try {
      ...
      toast('Error al extraer leads', 'error')
    } finally {
  ...
  return (
    <div className="flex h-[calc(100vh-14rem)] rounded-2xl border overflow-hidden bg-white dark:bg-slate-900">
      {/* Sidebar — lead list */}
      <div className={cn(
        ...
        {/* AI Extract Panel */}
        {showExtractDialog && (
          <div className="p-3 border-b bg-purple-50/50 dark:bg-purple-900/10 space-y-2">
            ...
            <textarea
              ...
              placeholder="Pega un email, lista de contactos, conversación de WhatsApp, o cualquier texto con datos de contacto..."
        ...
        <div className="flex-1 overflow-y-auto">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-slate-400">
              ...
              <p className="text-xs">No hay contactos</p>
            </div>
          ) : (
            leads.map((lead: any) => {
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      {lead.email && <span className="text-[10px] text-slate-400 truncate">{lead.email}</span>}
                    </div>
        ...
        {!selectedId ? (
          <div className="flex-1 flex flex-col items-center justify-center text-slate-400">
            ...
            <p className="text-xs max-w-xs text-center">
              Haz clic en un contacto de la lista para ver sus detalles, notas y recibir sugerencias de IA.
            </p>
          </div>
        ) : (
          <>
            {/* Detail header */}
            <div className="px-4 py-3 border-b flex items-center gap-3 bg-white dark:bg-slate-900">
            ...
            {/* Input bar */}
            <div className="px-4 py-3 border-t bg-white dark:bg-slate-900">
