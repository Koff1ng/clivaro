                    ...
                    <Table>
                        <TableHeader className="bg-gray-50 dark:bg-gray-800/50">
                            <TableRow>
                                ...
                                <TableHead className="py-3 px-4 font-semibold text-sm">Documento</TableHead>
                                <TableHead className="py-3 px-4 font-semibold text-sm">Contacto</TableHead>
                                <TableHead className="py-3 px-4 font-semibold text-sm">Fecha Ingreso</TableHead>
                                <TableHead className="py-3 px-4 font-semibold text-sm">Estado</TableHead>
                                <TableHead className="py-3 px-4 font-semibold text-sm text-right">Salario Base</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {isLoading ? (
                                ...
                                employees?.map((emp: any) => (
                                    <TableRow key={emp.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 border-b transition-colors">
                                        ...
                                        <TableCell className="py-3 px-4 text-sm text-gray-600 dark:text-gray-400">{emp.documentId}</TableCell>
                                        ...
                                        <TableCell className="py-3 px-4 text-sm">{new Date(emp.hireDate).toLocaleDateString()}</TableCell>
                                        <TableCell className="py-3 px-4">
                                            <Badge variant={emp.status === 'ACTIVE' ? 'default' : 'secondary'} className="rounded-full px-2.5 py-0.5 text-xs font-medium">
